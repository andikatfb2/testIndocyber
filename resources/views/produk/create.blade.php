    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{ route('produk.store')}}" method="POST" enctype="multipart/form-data" onSubmit="return validation()">
                @csrf
                    <div class="form-group row">
                        <label for="nama_produk" class="col-md-4 col-form-label text-md-right">{{ __('Nama Produk') }}</label>
                        <div class="col-md-6">
                            <input id="nama_produk" type="text" class="form-control @error('numeric') is-invalid @enderror" name="nama_produk" value="{{ old('nama_produk') }}" required autocomplete="nama_produk" autofocus maxlength="191">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="harga" type="number" class="form-control @error('numeric') is-invalid @enderror" name="harga" value="{{ old('harga') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="stok" type="number" class="form-control @error('numberic') is-invalid @enderror" name="stok" value="{{ old('stok') }}" required>
